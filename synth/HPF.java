...
/**
   A two pole resonant high-pass filter.
**/
...
public class HPF extends Filter
    ...
    public static final double MIN_CUTOFF = 0.0001;       // Not permitted to divide by zero
    public static final double MAX_CUTOFF = 0.9999;       // Numerical instability at Nyquist
    double lastCutoff = Double.NaN;
    double lastQ = Double.NaN;
    public double tick(long tickCount)
        {
        double q = (resonanceUnit.getValue() * 10 + 1) / Math.sqrt(2.0);
